...
TLDR_PROMPT_MODEL = os.getenv("TLDR_PROMPT_MODEL", "microsoft/phi-4-reasoning-plus")
...
def llm_paper_title_prompt(keywords: list[str]) -> str:
    """
    根據 keywords，向 LLM 要求生成一個與 SCI 領域有關的論文標題。
    回傳格式：str。
    """
    # 初始化 client
    client = OpenAI(
